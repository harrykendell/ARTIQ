...
from applets.dds_channel import DDSChannel, DDSParameters
from repository.utils.custom_list_widget import CustomListWidget
from PyQt5 import QtCore, QtGui, QtWidgets, QTimer
...
class DDS(QtWidgets.QDockWidget):
    ...
    def _dds_initialized(self, signal, value):
        self.timer = QTimer()
        self.timer.timeout.connect(self.get_dds_parameters)
