...
class TrapFrequencyExpFrag(ExpFragment):
    """
    Trap frequency measurement Power Reduction method
    1. Load MOT
    2. Compress MOT
    3. PGC
    4. Transfer to ODT
    ...
    def run_once(self):
        ...
        self.mot.dipole_trap_com_shift() # apply perturbation to excite COM motion
        #delay(0.5*ms)  # wait for perturbation to finish
